...
class WarmupCosLR(_LRScheduler):
    def __init__(
        ...
        # NOTE: upstream DiffusionDrive passed `verbose=False` to the
        # parent _LRScheduler, but torch 2.4+ removed the `verbose`
        # constructor argument. Our env has torch 2.7+cu128 -> drop it.
        self.min_lr = min_lr
        self.lr = lr
        self.epochs = epochs
